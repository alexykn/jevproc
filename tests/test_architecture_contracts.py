    ...
    assert result == {
        "rulesets": {
            "process": [
                {
                    "id": "JPR001",
                    "policy": {"warning_at": 0.12, "uncertain_at": 0.08},
                }
            ]
        }
    }
    assert defaults == {"rulesets": {"process": [{"id": "JPR001", "policy": {"warning_at": 0.12}}]}}
    assert override == {"rulesets": {"process": [{"id": "JPR001", "policy": {"uncertain_at": 0.08}}]}}
